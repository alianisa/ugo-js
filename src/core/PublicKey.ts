...
> {
  ...
  public address(): string {
    return bech32.encode('ugo', bech32.toWords(this.rawAddress()));
  }

  public pubkeyAddress(): string {
    return bech32.encode('ugopub', bech32.toWords(this.encodeAminoPubkey()));
  }
}
...
> {
  ...
  public address(): string {
    return bech32.encode('ugovalcons', bech32.toWords(this.rawAddress()));
  }
